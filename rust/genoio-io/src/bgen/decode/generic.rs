...
//! Generic BGEN Layout 2 probability decoding.
//!
...
use super::fast::{
    ...
    decode_selected_called_phased_16bit_a1_dosages_with_counts,
    decode_selected_called_unphased_8bit_a1_dosages,
    decode_selected_called_unphased_8bit_a1_dosages_into_sample_major_slot,
    decode_selected_unphased_8bit_a1_dosages, SampleMajorSlotMut, PHASED_16_BIT_DEPTH,
    UNPHASED_8_BIT_DEPTH,
};
use super::payload::ProbabilityPayloadBuffers;

#[cfg(test)]
use super::fast::decode_phased_16bit_a1_dosage;

const DOSAGE_TOLERANCE: f32 = 1.0e-6;
pub(super) const BIALLELIC_DIPLOID_STORED_PROBABILITY_COUNT: usize = 2;
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum PackedProbabilityLayout {
...
/// order.
#[derive(Default)]
pub(in crate::bgen) struct DosageDecodeBuffers {
    pub(in crate::bgen) probability: ProbabilityPayloadBuffers,
    pub(in crate::bgen) selected_values: Vec<f32>,
    pub(in crate::bgen) selected_missing_indices: Vec<usize>,
}
...
#[derive(Default)]
pub(in crate::bgen) struct HaplotypeDecodeBuffers {
    pub(in crate::bgen) probability: ProbabilityPayloadBuffers,
    pub(in crate::bgen) selected_haplotype_values: Vec<f32>,
    pub(in crate::bgen) selected_haplotype_missing_indices: Vec<usize>,
    pub(in crate::bgen) selected_collapsed_values: Vec<f32>,
    pub(in crate::bgen) selected_collapsed_missing_indices: Vec<usize>,
}

pub(in crate::bgen) fn decode_buffered_dosage_values(
    bgen: &Path,
    sample_count: u32,
...
/// generic decoder.
pub(in crate::bgen) fn try_decode_buffered_dosage_values_into_sample_major_slot(
    bgen: &Path,
    sample_count: u32,
    source_indices: &[usize],
    buffers: &mut DosageDecodeBuffers,
...
pub(in crate::bgen) fn try_decode_buffered_dosage_values_with_counts(
    bgen: &Path,
    sample_count: u32,
    source_indices: &[usize],
    buffers: &mut DosageDecodeBuffers,
...
pub(in crate::bgen) fn decode_buffered_haplotype_values(
    bgen: &Path,
    sample_count: u32,
    source_indices: &[usize],
...
pub(super) fn decode_phased_a1_dosage(
    bit_depth: u8,
    p_hap0_a0_raw: u32,
    p_hap1_a0_raw: u32,
) -> f32 {
