...
use genoio_core::{
    attach_variant_stats, compute_dosage_variant_stats, is_dosage_polymorphic, DenseDiagnostics,
...
pub(super) struct DosageFilterCounts {
    pub(super) allele_count: f64,
    pub(super) called_count: u64,
    pub(super) missing_count: u64,
}

impl DosageFilterCounts {
    pub(super) fn record_called_dosage(&mut self, value: f32) {
